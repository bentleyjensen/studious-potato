...
*    Sterling Jensen
* Summary:
*    Compare the average number of searches between binary and linear search
*    algorithms.
*
...
*     I deleted my work once and had to redo it. It made my code better, lol.
*
******************************************************************************/
...
float computeAverageLinear(int list[], int num)
{
   ...
   averageLinear = (float)total / (float)num;
...
float computeAverageBinary(int list[], int num)
{
   ...
   averageBinary = (float)total / (float)num;
